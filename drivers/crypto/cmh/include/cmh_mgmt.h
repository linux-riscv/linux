...
/*
 * Scrub up to two orphaned datastore objects on an ioctl error path.
 * Grant-with-no-access wipes the key material; the datastore stack space
 * itself is only reclaimed by a full reset.  Pass 0 to skip.
 */
