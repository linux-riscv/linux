 ...
 *
 * CRNG seeding: hwrng .quality is left at 0, which the hwrng core
 * elevates to full trust (1024) for a hardware RNG.  Set a fixed
 * quality in the hwrng initializer to lower the entropy estimate.
 */
