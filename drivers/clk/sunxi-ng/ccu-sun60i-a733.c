...
static SUNXI_CCU_M_DATA_WITH_MUX_GATE_FEAT(mbus_clk, "mbus", mbus_parents, 0x588,
					   0, 5,	/* M */
					   24, 3,	/* mux */
					   BIT(31),	/* gate */
					   CLK_IS_CRITICAL,
...
static SUNXI_CCU_M_DATA_WITH_MUX_GATE_FEAT(dram0_clk, "dram0", dram_parents, 0xc00,
					   0, 4,	/* M */
					   24, 3,	/* mux */
					   BIT(31),	/* gate */
					   CLK_IS_CRITICAL,
