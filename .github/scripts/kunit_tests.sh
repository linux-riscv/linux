...
/build/tuxrun/run --runtime null --device qemu-riscv64 --kernel $KERNEL_PATH --tests kunit --results /build/squad_json/kunit.json --log-file-text /build/squad_json/kunit.log --timeouts kunit=480 --rootfs $ROOTFS_PATH --boot-args "rw kunit.enable=1" || true
