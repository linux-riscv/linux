...
/build/tuxrun/run --runtime null --device qemu-riscv64 --kernel $KERNEL_PATH --tests xfstests-xfs --results /build/squad_json/xfstests.json --log-file-text /build/squad_json/xfstests.log --timeouts xfstests-xfs=480  --overlay /build/xfstests.tar.xz || true
